...
(0, _config.defineConfig)({
  ...
  migrate: {
    async adapter() {
      const { PrismaPg } = await Promise.resolve().then(() => jitiImport("@prisma/adapter-pg").then((m) => _interopRequireWildcard(m)));
